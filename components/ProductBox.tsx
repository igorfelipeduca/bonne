...
export default function ProductBox({ product }: { product: Product }) {
  ...
  return (
    <div className="flex flex-col gap-y-4">
      <Image
        src={`/${product.image}`}
        className="h-96 w-auto aspect-video object-cover cursor-pointer transition-all "
        isBlurred
      />
      ...
      <p className="text-zinc-700">
        ...
        aspernatur fugit consectetur excepturi maxime similique possimus totam
        soluta laudantium exercitationem, ipsam id autem ea.
      </p>
    </div>
  );
}
